...
* **云歌单同步**：粘贴网易云 MUSIC\_U Cookie 登录后自动拉取你的网易云歌单，一键同步
...
1. 安装 [Fabric Loader](https://fabricmc.net/)  ，[Fabric API](https://modrinth.com/mod/fabric-api)  和[AllMusic](https://github.com/Coloryr/AllMusic/releases)
...
在「我的」页点击「点击登录」，粘贴浏览器登录 music.163.com 后的 Cookie（需包含 `MUSIC\\\_U`）。登录成功后自动拉取你的网易云歌单。
